...
```
*   **(If you get an error saying 'npm not found'):** Your computer needs a tool called Node.js. Don't worry, you can install it instantly! Just paste this code, hit Enter, and try the `npm` command again:
    ```bash
